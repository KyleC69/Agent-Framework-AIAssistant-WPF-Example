...
public class SkModelDefinition
{
    /// <summary>
    ...
    ///     If this section is not included, the runtime will use the default options for the API and connection used by the
    ///     agent.
    /// </remarks>
    ...
    ///     The deployment parameter, in this example, is used to tell the runtime which deployment to use when executing
    ///     against Azure OpenAI.
    /// </remarks>
    public SkModelConnection? Connection { get; set; }
