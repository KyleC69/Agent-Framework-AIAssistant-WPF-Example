...
public class SeniorCoderAgent2
{
    ...
    public SeniorCoderAgent2(IChatClient chatClient, ILoggerFactory factory)
    {
        ...
        _agent = chatClient.AsAIAgent(new ChatClientAgentOptions
        {
            ...
            Name = "SeniorCoder2",
            Description =
                        "A specialized agent for advanced software development, code analysis, and implementation guidance.",
    ...
    public static implicit operator AIAgent(SeniorCoderAgent2 agent)
    {
        return agent._agent;
    }
