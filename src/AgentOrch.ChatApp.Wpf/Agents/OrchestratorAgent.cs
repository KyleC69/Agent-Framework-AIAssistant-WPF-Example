...
public class OrchestratorAgent
{
    ...
    public OrchestratorAgent(IChatClient chatClient, AIAgent[] agentsAsTools, ILoggerFactory factory)
    {
    ...
    {
        List<AITool> tools = ToolBuilder.GetAiTools().ToList();
        foreach (AIAgent agent in agentsAsTools)
        {
