...
public class ControlAgent
{
    ...
    public ControlAgent(OllamaApiClient chatClient, ILoggerFactory factory)
    {




        chatClient = new OllamaApiClient("http://localhost:11343", "llama3.2:1b");


        _agent = chatClient.AsAIAgent(name: "ControlAgent",
