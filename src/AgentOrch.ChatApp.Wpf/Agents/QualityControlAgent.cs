...
public class QualityControlAgent
{
    ...
    public QualityControlAgent(IChatClient chatClient, ILoggerFactory factory)
    {
        _agent = chatClient.AsAIAgent(
                ...
                instructions: """
                              You are the Quality Control Agent. Your role is to review and validate the work produced by other agents.
                              ...
                              Your output should always be a structured, actionable quality review.
                              """
        );
    }
